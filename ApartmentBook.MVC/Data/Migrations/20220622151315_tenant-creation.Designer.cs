...
namespace ApartmentBook.MVC.Data.Migrations
{
    ...
    [Migration("20220622151315_tenant-creation")]
    partial class Tenantcreation
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ApartmentBook.MVC.Features.Apartments.Models.Apartment", b =>
                {
                    b.HasOne("ApartmentBook.MVC.Features.Auth.Models.ApplicationUser", "User")
                        .WithMany("Apartments")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("ApartmentBook.MVC.Features.Auth.Models.ApplicationUser", null)
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
